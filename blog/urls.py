...
from . import views
from .views import (AllSaveView, PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, 
                    SaveView, UserPostListView, LikeView, LikeCommentView, posts_of_following_profiles, AllLikeView)

urlpatterns = [
    path('home/', views.first, name='firsthome'),
